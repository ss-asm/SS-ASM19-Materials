...
Dataset you used to approach this problem. What data is available to measure progress on your problem? See [Zara's notebook](https://github.com/ss-asm/SS-ASM19-Materials/blob/master/Statistics/Statistics%201%20Zara%20Shabrina.Rmd) from the first day. Provide tables or figures from these datasets that tell us something about your challenge.
...
*Suggestion: Then get specific with a spatial example.*
```{r }
